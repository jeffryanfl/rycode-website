...
- New Economics piece → `src/pages/economics/<slug>.astro` on the charcoal Economics paper (Newsreader title, italic dek, 1px rule, Inter headings, no cyan). Add a row on `/economics` only when it is published. Do not invent copy. Do not clone the Research journal list onto `/economics`. Do not put Economics essays under `/research`. Live: `/economics/post-inflation-dollars-pay-pre-inflation-debts/` (body + Sources; no number-card rail), `/economics/warsh-first-hike-oil-and-five-percent-ten-year/` (body + Sources; no number-card rail this pass), `/economics/still-1998-not-1999/`, `/economics/jobs-print-was-strong-mix-is-the-story/`. Source: `docs/economics/`. Do not create `/economics/people-who-use-ai-get-the-jobs/`.
