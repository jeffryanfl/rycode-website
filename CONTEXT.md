...
**Rycode.** A hub with four HOME marks in a two-by-two: Economics, Risk, Systems, and A.I. Tools lives at `/tools` but is off HOME. Live site: https://rycode.dev. A.I. is the brain mark in the bottom-right cell. Systems goes out to https://grc.rycode.dev. There is no Research door and no Insights door.
